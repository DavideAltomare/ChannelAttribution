...
In the following example we will show how R package [ChannelAttribution](https://channelattribution.io) can be used to perform multi-touch attribution using heuristic models and Markov model.
...
<img src="https://app.channelattribution.net/img/R_total_value.png" width="100%" height="auto" >
<br />
<br />
